...
// import { init_fetch } from "./../actions/results.js"; later
  ...
  onKeyDown = e => {
    ...
    if (e.keyCode === 13) {
      this.setState({
        ...
        //this.props.init_fetch(userInput) later
       //this.props.user_input(this.state.userInput)
    }
  ...
  render() {
    ...
    return (
            ...
            <InputBase
              ...
              value={userInput}
              fullWidth
              placeholder="Search for motor service providers..."
              inputProps={{ 'aria-label': 'search motor service providers' }}
            />
  					{suggestions_list}
		      </Container>
		</Fragment>
